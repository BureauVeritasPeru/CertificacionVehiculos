...
$fileName = "reporte_general_gnv" . date('Ymd') . ".xls";
function number_pad($number,$n) {
    return str_pad((int) $number,$n,"0",STR_PAD_LEFT);
}

$fechaIni       =OWASP::RequestString('fechaIni2');
$fechaFin       =OWASP::RequestString('fechaFin2');
...
<table>
    ...
    <?php 
    $list=CrmReportes::getItemReporteGeneralGNV($fechaIni,$fechaFin,$userID);

...
function AsignarCalcomania(){
    ...
    while ($variable < $cantidad) {
        ...
        $oCalcomania = new eGlpCalcomania();
        ...
        if(GlpCalcomania::AddNew($oCalcomania)){
            $nro_inicial+=1;
            $variable+=1;            
        }
        else {
            RaiseError(GlpCalcomania::GetErrorMsg());
            return;
        }
	}
...
function ReasignarCalcomania(){
    ...
    while ($nro_inicialre <= $nro_finalre) {
        ...
        if(GlpCalcomania::Update($oCalcomania)){
            $nro_inicialre+=1;         
        }
        else {
            RaiseError(GlpCalcomania::GetErrorMsg());
...
function EliminarCalcomania(){
    ...
    while ($nro_inicialdel <= $nro_finaldel) {
        ...
        if(GlpCalcomania::Delete($oCalcomania)){
            $nro_inicialdel+=1;         
        }
        else {
            RaiseError(GlpCalcomania::GetErrorMsg());

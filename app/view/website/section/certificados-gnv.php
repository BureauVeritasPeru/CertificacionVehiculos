...
$listAforo = NULL;
$lCliente = NULL;
$oCert = GnvCertificado::getItem($certificadoID);
if($oCert != NULL){
	$oPrecert = GnvPrecertificado::getItem($oCert->precertID);
	$oRest = GnvRestriccion::getItem($oCert->precertID);
...
<script type="text/javascript">
	$(function(){$('#placaRest').attr('readonly','true');
		<?php if($oCert != NULL){ ?> $('.proob').show(); $('.hide-valid2').hide(); <?php  if($oCert->formatoID != 0) { ?> $('.hide-valid').show();<?php }else{ ?> $('.hide-valid').hide();<?php }  ?>
		<?php 
		switch ($oCert->tipoCliente) {
			case 1:
	...
	<section class="content">
		<form name="frmMain" id="frmMain" class="form-horizontal" method="post" autocomplete="off" >
			<div class="box box-default">
				<div class="box-header">
					<h3 class="box-title"><i class="fa fa-inbox"></i>&nbsp;<?php if($oCert != NULL){ echo 'Edición del Certificado GNV N° '.$oCert->certificadoID;} else echo 'Nuevo Certificado GNV'; ?></h3>
				</div>
				<br>
				<div class="box-body">
						...
						<div class="row">
							...
							<div class="col-sm-4">
								<select name="tipocertID" id="tipocertID" class="form-control input-sm" autocomplete="off">
									<option value="0">[SELECCIONE]</option>  <?php $list= CmsParameterLang::getWebListParent(12, 71, 1); foreach ($list as $obj) { echo "<option value=\"".$obj->parameterID."\""; if($oPrecert != NULL){ if($obj->parameterID==$oPrecert->tipocertID) echo 'selected="true"';} echo ">".$obj->parameterName."</option>"; } ?>   
								</select>
							</div>
						</div>
					</div>
					<div class="form-group">
						<div class="row">                       
							...
							<div class="col-sm-4">
								<input type="text" class="form-control input-sm" id="placa" name="placa" placeholder="Ingrese N° de placa" maxlength="28" value="<?php if($oPrecert != NULL){ echo $oPrecert->placa; } ?>" >
							</div>
							<script type="text/javascript">
								$(function(){
							...
							<div class="col-sm-2">
								<p class="text-right">Color :</p>
							</div>
							<div class="col-sm-3">
								<select name="colorID" id="colorID" class="form-control input-sm" autocomplete="off">
									<option value="0">[SELECCIONE]</option>  <?php $list= CmsParameterLang::getWebList(6, 1); foreach ($list as $obj) { echo "<option value=\"".$obj->parameterID."\""; if($oPrecert != NULL){ if($obj->parameterID==$oPrecert->colorID) echo 'selected="true"';} echo ">".$obj->parameterName."</option>"; } ?>   
								</select>
							</div>
							<div class="col-sm-1">
								<a href="#newColor" id="btnNewColor" role="button" class="btn btn-primary btn-sm" data-toggle="modal" data-backdrop="static" title="Nuevo Color" tabindex="-1"><span class="fa fa-plus"></span></a>
							</div>
							<div id="newColor" class="modal fade">
										...
										<div class="modal-body">
											<div class="form-group">
												<div class="row">
													...
													<div class="col-sm-10">
														<input type="text" class="form-control input-sm" id="colorNew" name="colorNew" placeholder="Ingrese color" maxlength="100">
													</div>
												</div>
											</div>
										</div>
										<div class="modal-footer">
											<div class="row">
												<div class="col-sm-4 col-sm-offset-8">
													<div class="btn btn-primary btn-block" id="btnAddColor"><i class="fa fa-floppy-o"></i>&nbsp;&nbsp;Agregar Color</div>
												</div>
											</div>
										</div>
									</div>
						...
						<div class="row">
							...
							<div class="col-sm-3">
								<select name="modeloID" id="modeloID" class="form-control input-sm" autocomplete="off">
									<option value="0">[SELECCIONE]</option><?php if($oPrecert != NULL){ $oModelo = CmsParameterLang::getItem($oPrecert->modeloID,1);?><option value="<?php echo $oModelo->parameterID; ?>" selected><?php echo $oModelo->parameterName; ?></option><?php  } ?>
								</select>
							</div>
							<div class="col-sm-1">
						...
						<div class="row">
							...
							<div class="col-sm-3">
								<select name="categoriaID" id="categoriaID" class="form-control input-sm" autocomplete="off">
									...
									<?php $list= CmsParameterLang::getWebList(4, 1); foreach ($list as $obj) { echo "<option value=\"".$obj->parameterID."\""; if($oPrecert != NULL){ if($obj->parameterID==$oPrecert->categoriaID) echo 'selected="true"';} echo ">".$obj->parameterName."</option>";} ?>   
								</select>
							</div>
							<div class="col-sm-1">
							...
							<div class="col-sm-3">
								<select name="combustibleID" id="combustibleID" class="form-control input-sm" autocomplete="off">
									<option value="0">[SELECCIONE]</option> 
									<?php
                                  $list= CmsParameterLang::getWebList(7, 1); //Combustible
                                  foreach ($list as $obj) {
                                  	echo "<option value=\"".$obj->parameterID."\"";
                                  	if($oPrecert != NULL){ if($obj->parameterID==$oPrecert->combustibleID) echo 'selected="true"';}
                  ...
                  <div class="form-group">
                  	<div class="row">
                  		...
                  		<div class="col-sm-4">
                  			<input type="text" min="0" class="form-control input-sm" id="cilindros" name="cilindros" placeholder="Ingrese N° de cilindros" maxlength="2" value="<?php if($oPrecert != NULL){ echo $oPrecert->cilindros; } ?>">
                  		</div>
                  		<div class="col-sm-2">
                  			<p class="text-right">Cilindrada :</p>
                  		</div>
                  		<div class="col-sm-4">
                  			<input type="text" min="0" class="form-control input-sm" id="cilindrada" name="cilindrada" placeholder="Ingrese cilindrada" maxlength="8" value="<?php if($oPrecert != NULL){ echo $oPrecert->cilindrada; } ?>">
                  		</div>
                  	</div>
                  </div>
                  <div class="form-group">
                  	<div class="row">
                  		...
                  		<div class="col-sm-4">
                  			<input type="text" min="0" class="form-control input-sm" id="ejes" name="ejes" placeholder="Ingrese N° de ejes" maxlength="2" value="<?php if($oPrecert != NULL){ echo $oPrecert->ejes; } ?>">
                  		</div>
                  		<div class="col-sm-2">
                  			<p class="text-right">N° de ruedas :</p>
                  		</div>
                  		<div class="col-sm-4">
                  			<input type="text" min="0" class="form-control input-sm" id="ruedas" name="ruedas" placeholder="Ingrese N° de ruedas" maxlength="2" value="<?php if($oPrecert != NULL){ echo $oPrecert->ruedas; } ?>">
                  		</div>
                  	</div>
                  </div>
                  <div class="form-group">
                  	<div class="row">
                  		...
                  		<div class="col-sm-4">
                  			<input type="text" min="0" class="form-control input-sm" id="asientos" name="asientos" placeholder="Ingrese N° de asientos" maxlength="2" value="<?php if($oPrecert != NULL){ echo $oPrecert->asientos; } ?>">
                  		</div>
                  		<div class="col-sm-2">
                  			<p class="text-right">N° de pasajeros :</p>
                  		</div>
                  		<div class="col-sm-4">
                  			<input type="text" min="0" class="form-control input-sm" id="pasajeros" name="pasajeros" placeholder="Ingrese N° de pasajeros" maxlength="2" value="<?php if($oPrecert != NULL){ echo $oPrecert->pasajeros; } ?>">
                  		</div>
                  	</div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                  	<div class="row">
                  		<div class="col-sm-2">
                  			<p class="text-right">Peso Neto :</p>
                  		</div>
                  		<div class="col-sm-2">
                  		...
                  		<div class="col-sm-2">
                  			<p class="text-right">Peso Bruto :</p>
                  		</div>
                  		<div class="col-sm-2">
                  ...
                  <div id="divModifCombPeso" style="<?php if($oPrecert == NULL){ echo 'display:none'; } else if($oPrecert != NULL){ if($oPrecert->tipocertID == 74) echo 'display:block'; else echo 'display:none'; }?>">
                  	<br>
                  	<legend style="text-align:left;">Modificación de combustible y peso neto</legend>
                  	<div class="form-group">
                  		<div class="row">
                  			<div class="col-sm-2">
                  			...
                  			<div class="col-sm-2">
                  				<p class="text-right">Peso Neto Modificado :</p>
                  			</div>
                  			<div class="col-sm-2">
                  				<input name="pesoNetoMod" type="text" id="pesoNetoMod" readOnly class="form-control input-sm" placeholder="Ingrese nuevo peso neto" maxlength="7" value="<?php if($oPrecert != NULL){ echo $oPrecert->pesoNetoMod; } ?>">
                  			</div>
                  			<div class="col-sm-2">
              	...
              	<div class="tab-content">
              		<div id="sectionA" class="tab-pane fade in active">
              			...
              			<div id="divSinPropiedad">
              				...
              				<div class="form-group">
              					<div class="row" id="divInsSP" style="<?php if($oSP != NULL){ echo 'display:none'; }?>">
              						<div class="col-sm-2 col-sm-offset-10">
              							<div class="btn btn-primary" id="btnSaveSP"><i class="fa fa-floppy-o"></i>&nbsp;&nbsp;Grabar Cliente</div>
              						</div>
              					</div>
              					<div class="row" id="divActSP" style="<?php if($oSP == NULL){ echo 'display:none'; }?>">
              						<div class="col-sm-2 col-sm-offset-10">
              				...
              				<div class="row">
              					<table class="table table-striped table-hover table-condensed table-bordered table-responsive" id="tbComponentes">
              						...
              						<tbody id="list-comp">
              							...
              							if($oCert != NULL){ 
              								$lComponentes  =GnvCompInst::getListByCertificado($oCert->certificadoID);
              						...
              						<table class="table  table-hover table-bordered table-responsive" id="tbDocumentos">
              							...
              							<tbody><?php  $list= CmsParameterLang::getWebList(10, 1); if($oCert != NULL){ $listAforo = GlpAforoDoc::getListByCertificado($oCert->certificadoID);}$count=0;foreach ($list as $obj) {$count++;if($oCert != NULL){ $countSpecial = CrmManagePhoto::getCountFilter($oCert->precertID,$obj->parameterID);$photo = CrmManagePhoto::getItemFilter($oCert->precertID,$obj->parameterID);}?>
              								<tr>
              									...
              									<td class="proob sumador" style="display: none;"><?php if($oCert != NULL){ echo $countSpecial->archivo;}else{ echo '0';} ?></td><?php if($oCert != NULL){ if($countSpecial->archivo != '0'){ if($obj->parameterID != '46'){ ?>
              									<td class="proob" style="display: none;"><a href="<?php echo SEO::get_URLRoot().'userfiles/'.CrmManagePhoto::getRoute($obj->parameterID).$photo->archivo; ?>" target="_blank"><div class="btn btn-primary btn-ms"><i class="fa fa-search"></i></div></a></td>
              									<?php }else{ ?>
              									<td class="proob" style="display: none;">
              										<div class="btn btn-primary btn-ms modal-photo"><i class="fa fa-search"></i></div>
              										<div class="btn btn-primary btn-ms update<?= $obj->parameterID ?>"><i class="fa fa-upload"></i></div>
              									</td><?php } ?><?php }else{ ?>
              									<td class="proob" style="display: none;"><div class="btn btn-primary btn-ms update<?= $obj->parameterID ?>"><i class="fa fa-upload"></i></div>
              									</td>
              									<?php } }else{ ?>
              									<td class="proob" style="display: none;"><div class="btn btn-primary btn-ms update<?= $obj->parameterID ?>"><i class="fa fa-upload"></i></div>
              									</td>  
              					...
              					<script type="text/javascript">
              						$(function(){
              							$('#btn-acept-rest').click(function(){
              								$.getJSON('<?php echo $URL_ROOT;?>ajax/insert_restriccion_gnv.php?precertID='+$('#precertID').val()+'&placaRest='+$('#placaRest').val()+'&observacionesRest='+$('#observacionesRest').val(), function(data) {
              									if(data.retval==1){
              										alertify.success(data.message);
              										$('.hide-valid2').hide();
              									}else{
              				...
              				<div class="row">
              					...
              					<div class="col-sm-3">
              						<select name="tallerID" id="tallerID" class="form-control input-sm" autocomplete="off">
              							<option value="0">[SELECCIONE]</option>  <?php $list= CrmTaller::getWebListGNV(); foreach ($list as $obj) { echo "<option value=\"".$obj->tallerID."\""; if($oCert != NULL){ if($obj->tallerID==$oCert->tallerID) echo 'selected="true"';} echo ">".$obj->razonSocial."</option>"; } ?>
              						</select>
              					</div>  
              					<div class="col-sm-1">
              					...
              					<div class="hide-valid">
              						<div class="col-sm-2 col-sm-offset-1" style="display: none;">
              				...
              				<div class="row">
              					...
              					<div class="col-sm-4">
              						<select name="sedeID" id="sedeID" class="form-control input-sm">
              							<option value="0">[SELECCIONE]</option>
              							<?php if($oCert != NULL){ $oSede = CrmSede::getItem($oCert->sedeID); ?>
              								<option value="<?php echo $oSede->sedeID; ?>" selected><?php echo $oSede->descripcion; ?></option>
              								<?php } ?>
              							</select>
              						</div>
          	...
          	<div class="modal-dialog modal-lg" role="document" >
          		...
          		<script>
          			...
          			function getMessage(retVal,msg,msg2){
          				...
          				}else{alert(msg);console.log(msg);}
          			}
          ...
          <div class="modal fade modal-fake" tabindex="-1" role="dialog" >
          	<div class="modal-dialog modal-lg" role="document" >
          		<div class="modal-content">
          			<div class="modal-header">
          				<button type="button" class="close" data-dismiss="modal" aria-label="Close" id="btn_close"><span aria-hidden="true">&times;</span></button>
          				<h4 class="modal-title" id="gridSystemModalLabel">Listado de Fotos</h4><?php $photos = CrmManagePhoto::getListFilter($oCert->certificadoID,46); ?>
          				<ul><?php foreach ($photos as $var) {echo '<li><a href="'.SEO::get_URLRoot().'userfiles/'.CrmManagePhoto::getRoute(46).$var->archivo.'" target="_blank">'.$var->archivo.'</a></li>';} ?>
          				</ul>
          			</div>
          		</div>
          	</div>
          			...
          			<form id="frm5" name="frm5" autocomplete="off" enctype="multipart/form-data" method="post" target="hideFrame">
          				...
          				<div class="modal-body">
          					<div class="row">
          						...
          						<div class="col-md-6">
          							<div class="form-group">
          								<label>&nbsp;</label><div class="btn btn-primary btn-block" name="btnCrear" id="send_upload2"><i class="fa fa-floppy-o"></i>&nbsp;Guardar</div>
          							</div>
          						</div>  
          					</div>            
          				</div>
      ...
      <script>
      	function getClienteN(n){
      		$.getJSON('<?php echo $URL_ROOT;?>ajax/form_certificado_gnv.php?action=getCliN&nID='+n, function(data) {
      			if(data.retval==1){
      	...
      	function RemoveModal(n,s){
      		$.getJSON('<?php echo $URL_ROOT;?>ajax/form_certificado_gnv.php?action=removeCliN&nID='+n+'&preID='+s, function(data) {
      			if(data.retval==1){
      				$(".fila_"+n).remove();
      			}else{
      				alertify.error(data.message);
      	...
      	$(function(){
      		...
      		$("#tipocertID").change(function(){
      			if($(this).val() == 87 || $(this).val() == 88 || $(this).val() == 0){
      		...
      		$('#btnAddMarca').click(function(){
      			...
      			$.getJSON('<?php echo $URL_ROOT;?>ajax/form_certificado_gnv.php?action=addMarca&'+fields, function(data) {
      				if(data.retval==1){
      					alertify.success(data.message);
      		...
      		$('#btnAddModelo').click(function(){
      			...
      			$.getJSON('<?php echo $URL_ROOT;?>ajax/form_certificado_gnv.php?action=addModelo&'+fields, function(data) {
      				if(data.retval==1){
      					alertify.success(data.message);
      		...
      		$('#btnAddCategoria').click(function(){
      			...
      			$.getJSON('<?php echo $URL_ROOT;?>ajax/form_certificado_gnv.php?action=addCategoria&'+fields, function(data) {
      				if(data.retval==1){
      					alertify.success(data.message);
      		...
      		$('#btnAddCombustible').click(function(){
      			...
      			$.getJSON('<?php echo $URL_ROOT;?>ajax/form_certificado_gnv.php?action=addCombustible&'+fields, function(data) {
      				if(data.retval==1){
      					alertify.success(data.message);
      		...
      		$('#btnAddColor').click(function(){
      			var fields=$('#frmMain').serialize();
      			if ($('#colorNew').val() == ''){ $('#colorNew').focus(); alertify.error('Ingrese color'); return false; }
      			$.getJSON('<?php echo $URL_ROOT;?>ajax/form_certificado_gnv.php?action=addColor&'+fields, function(data) {
      				if(data.retval==1){
      					alertify.success(data.message);
      					$("#newColor").modal("toggle");
      					$('#colorNew').val('');
      					$('#colorID').load('<?php echo $URL_ROOT;?>ajax/select-colorPopup.php');
      				}else{
      					alertify.error(data.message)
      				}
      			}).error(function(jqXHR, textStatus, errorThrown) {
      		...
      		$('#btnSavePrecert').click(function(){
      			...
      			if ($('#colorID').val() == '0'){ $('#colorID').focus(); alertify.error('Seleccione un color'); return false; }
      			...
      			$.getJSON('<?php echo $URL_ROOT;?>ajax/form_certificado_gnv.php?action=insert&'+fields, function(data) {
      				if(data.retval==1){
      					alertify.success(data.message); 
...
$('#btnActPrecert').click(function(){
	...
	$.getJSON('<?php echo $URL_ROOT;?>ajax/form_certificado_gnv.php?action=update&'+fields, function(data) {
		if(data.retval==1){
			alertify.success(data.message);
		}else{
			alertify.error(data.message)
...
$('#btnSearchCli').click(function(){
	...
	$.getJSON('<?php echo $URL_ROOT;?>ajax/form_certificado_gnv.php?action=searchCli&'+fields, function(data) {
		if(data.retval==1){
			$("#list-cliente tr").remove();
...
$('#btnSaveCliente').click(function(){
	...
	$.getJSON('<?php echo $URL_ROOT;?>ajax/form_certificado_gnv.php?action=saveCli&'+fields, function(data) {
		if(data.retval==1){
			alertify.success(data.message);
			$('#divInsCli').attr('style','display:none');
			$('#divActCli').attr('style','display:block');
			$('#clienteID').attr('value',data.clienteID);
			$('#tipoDoc').attr('disable','true');
			$('#numDoc').attr('disable','true');
...
$('#btnSaveClienteJur').click(function(){
	...
	$.getJSON('<?php echo $URL_ROOT;?>ajax/form_certificado_gnv.php?action=saveCliJur&'+fields, function(data) {
		if(data.retval==1){
			alertify.success(data.message); 
...
$('#btnActClienteJur').click(function(){
	...
	if ($('#direccion').val() == ''){ $('#direccion').focus(); alertify.error('Ingrese una direccion'); return false; }
	if ($('#email').val() == '0'){ $('#email').focus(); alertify.error('Ingrese un email'); return false; }
	$.getJSON('<?php echo $URL_ROOT;?>ajax/form_certificado_gnv.php?action=actCliJur&'+fields, function(data) {
		if(data.retval==1){
			alertify.success(data.message);
		}else{
			alertify.error(data.message);
...
$('#btnSaveSP').click(function(){
	...
	$.getJSON('<?php echo $URL_ROOT;?>ajax/form_certificado_gnv.php?action=saveCliSP&'+fields, function(data) {
		if(data.retval==1){
			alertify.success(data.message); 
...
$('#btnActSP').click(function(){
	...
	if ($('#celularSP').val() == '0'){ $('#celularSP').focus(); alertify.error('Ingrese un celular'); return false; }
	var fields=$('#frmMain').serialize();
	console.log('<?php echo $URL_ROOT;?>ajax/form_certificado_gnv.php?action=actCliSP&'+fields);
	$.getJSON('<?php echo $URL_ROOT;?>ajax/form_certificado_gnv.php?action=actCliSP&'+fields, function(data) {
		if(data.retval==1){
			alertify.success(data.message);
		}else{
			alertify.error(data.message);
...
$('#btnAddClienteNatural').click(function() {
	...
	if ($('#numDoc').val() == ''){ $('#numDoc').focus(); alertify.error('Ingrese N° de documento'); return false; }
	var fields=$('#frmMain').serialize();
	$.getJSON('<?php echo $URL_ROOT;?>ajax/form_certificado_gnv.php?action=addCliNatural&'+fields, function(data) {
		if(data.retval==1){
			alertify.success(data.message); 
			$("#myModalClientes").modal("hide");
			$('#list-cli').append('<tr class="fila_'+data.clienteID+'"><td><a href="javascript:getClienteModal('+data.clienteID+');"><i class="fa fa-pencil-square-o"></i></a>&nbsp;<a href="javascript:RemoveModal('+data.clienteID+','+$('#precertID').val()+')"><i class="fa fa-times"></i></a></td><td>'+$('#name').val()+'</td><td>'+$('#lastname').val()+'</td><td>'+$('#numDoc').val()+'</td><td>'+$('#phone').val()+'</td></tr>');
			$('#divInsCli').show();
			$('#divActCli').hide();
...
$('#btnActCliente').click(function(){
	...
	if ($('#lastname').val() == ''){ $('#lastname').focus(); alertify.error('Ingrese apellidos'); return false; }
	if ($('#celular').val() == ''){ $('#celular').focus(); alertify.error('Ingrese celular'); return false; }
	$.getJSON('<?php echo $URL_ROOT;?>ajax/form_certificado_gnv.php?action=actCli&'+fields, function(data) {
		if(data.retval==1){
			alertify.success(data.message);
...
$( "#btnAddComponente" ).click(function() {
	...
	if(tipoCompID == 78){
		$.getJSON('<?php echo $URL_ROOT;?>ajax/insert_pesoModGNV.php?precertID='+$('#precertID').val()+'&pesoNetoMod='+$('#pesoNetoMod').val()+'&cargaUtilMod'+$('#cargaUtilMod').val(), function(data) {
			if(data.retval==1){
...
$('#btnSaveCert').click(function(){
	...
	if ($('#clienteID').val() == ''){
		$('#li_A').attr('class','active');
		$('#li_E').attr('class','');
		$('#sectionA').attr('class','tab-pane fade active in');
		$('#sectionE').attr('class','tab-pane fade');
	}

	<?php 
            $list= CmsParameterLang::getWebList(10, 1); //Aforo Documentario
            $count=0;
            foreach ($list as $obj){
            	$count++;
            	?>
            ...
            var fields=$('#frmMain').serialize();
            $.getJSON('<?php echo $URL_ROOT;?>ajax/form_certificado_gnv.php?action=insertCert&'+fields, function(data) {
            	if(data.retval==1){
            		alertify.success(data.message);
...
$('#btnActCert').click(function(){
	...
	<?php 
            ...
            if ($('#sedeID').val() == '0'){ $('#sedeID').focus(); alertify.error('Seleccione una sede del taller'); return false; }
            var fields=$('#frmMain').serialize();
            $.getJSON('<?php echo $URL_ROOT;?>ajax/form_certificado_gnv.php?action=actCert&'+fields, function(data) {
            	if(data.retval==1){
            		alertify.success(data.message);
            	}else{
            		alertify.error(data.message)
...
// 	$.getJSON('<?php echo $URL_ROOT;?>ajax/form_certificado_gnv.php?action=changeFormato&'+fields, function(data) {
// 		if(data.retval==1){
// 			alertify.success(data.message);
...
$('#btnDownload').click(function(){
	var fields=$('#frmMain').serialize();
	if($('#tipocertID').val() == 87){
		window.open('<?php echo $URL_ROOT;?>ajax/form_certificado_gnv.php?action=downloadAnual&'+fields,'_blank');
	}
	else if($('#tipocertID').val() == 74){
		window.open('<?php echo $URL_ROOT;?>ajax/form_certificado_gnv.php?action=downloadInicial&'+fields,'_blank');
	}
	else if($('#tipocertID').val() == 88){
		window.open('<?php echo $URL_ROOT;?>ajax/form_certificado_gnv.php?action=downloadOriginal&'+fields,'_blank');
	}
});

...
$list2 = GlpCertificado::getList_Paging($usuarioID, $filtroID, $filtro, $startDate, $endDate);
	...
	<form name="frmMain" id="frmMain" class="form-horizontal" method="post" autocomplete="off" >
		<div class="box box-default">
			<div class="box-header">
				<h3 class="box-title"><i class="fa fa-inbox"></i>&nbsp; Consulta de Certificados GLP</h3>
			</div>
			<br>
			<div class="box-body">
        <div class="row">
      ...
      <table class="table table-striped table-hover table-condensed table-bordered table-responsive">
        <thead>
          <tr>
            <th>&nbsp;</th>
            <th style="text-align:center;">N° Certificado</th>
            <th style="text-align:center;">Fecha Emisión</th>
            <th style="text-align:center;">N° Formato</th>
        ...
        <tbody id="list-cert">
          ...
          foreach ($list2 as $oItem){
            ...
            <tr>
              <td nowrap="nowrap">
                <a href="<?php echo $URL_ROOT.'certificados.html?action=update&certificadoID='.$oItem->certificadoID; ?>" title="Editar" id="btnEdit"><i class="fa fa-eye"></i></a>
              </td>
...
<script>
  $(function(){
    $('#send_export').click(function(){
      location.href = '<?php echo $URL_ROOT;?>ajax/export_glp.php?filtroID='+$('#filtroID').val()+'&filtro='+$('#filtro').val()+'&startDate='+$('#startDate').val()+'&endDate='+$('#endDate').val();
    });
    ...
    $('#btnBuscar').on('click', function(){
      ...
      endDate   = $('#endDate').val();
      location.href='<?php echo SEO::get_URLROOT(); ?>consultas.html?filtroID='+filtroID+'&filtro='+filtro+'&startDate='+startDate+'&endDate='+endDate;
    });

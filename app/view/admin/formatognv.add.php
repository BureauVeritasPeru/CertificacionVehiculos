            ...
            <script type="text/javascript">
                $(function(){
                    ...
                    $('#grabar').click(function(){
                        ...
                        console.log('<?php echo $URL_ROOT;?>ajax/formatognv.php?action=asignar&'+fields2);

                        $.getJSON('<?php echo $URL_ROOT;?>ajax/formatognv.php?action=asignar&'+fields2, function(data) {
                            if(data.retval==1){

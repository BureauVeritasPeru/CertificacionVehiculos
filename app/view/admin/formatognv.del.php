        ...
        <script type="text/javascript">
            $(function(){
                    ...
                    $('#eliminarF').click(function(){
                        ...
                        console.log('<?php echo $URL_ROOT;?>ajax/formatognv.php?action=eliminar&'+fields2);

                        $.getJSON('<?php echo $URL_ROOT;?>ajax/formatognv.php?action=eliminar&'+fields2, function(data) {

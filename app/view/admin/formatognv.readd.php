            ...
            <script type="text/javascript">
                $(function(){
                    ...
                    $('#reasignarF').click(function(){
                        ...
                        console.log('<?php echo $URL_ROOT;?>ajax/formatognv.php?action=reasignar&'+fields2);

                        $.getJSON('<?php echo $URL_ROOT;?>ajax/formatognv.php?action=reasignar&'+fields2, function(data) {
                            if(data.retval==1){
                                alertify.success(data.message);
                                location.href= '<?php echo SEO::get_URLAdmin(); ?>?moduleID=46';
                            }else{

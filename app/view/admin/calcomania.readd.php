            ...
            <script type="text/javascript">
                $(function(){
                    ...
                    $('#reasignarF').click(function(){
                        ...
                        console.log('<?php echo $URL_ROOT;?>ajax/calcomania.php?action=reasignar&'+fields2);

                        $.getJSON('<?php echo $URL_ROOT;?>ajax/calcomania.php?action=reasignar&'+fields2, function(data) {
                            if(data.retval==1){

...
$list=CrmReportes::getItemReportexTallerGNVA($fechaIni,$fechaFin,$usuarioID,$tallerID,$tipocertID,$placa);
$count = 0;
...
<table>
    ...
    <tr><th colspan="6">&nbsp;</th></tr>
    <tr>
        <th colspan="3" style="font-weight: bold; text-align: left;"><?php echo $oTaller->razonSocial; ?></th>
        <th colspan="3" style="font-weight: bold; text-align: right;">PER-<?php echo $oTaller->per; ?></th>
    </tr>
    <tr><th colspan="6">&nbsp;</th></tr>
    <tr>
    ...
    foreach ($list as $oItem){
        ...
        <tr>
            ...
            <td class="<?php echo $valor; ?>"><?php echo GnvCertificado::getState($oItem->estado) ?></td>

...
class GnvFormato extends Database
{
  ...
  public static function  getList_Paging(){
      ...
      FROM gnv_formato f INNER JOIN crm_user a
  ...
  public static function  AddNew($oFormato){
        //Search the max Id
        //$query = " 	SELECT MAX(formatoID) FROM gnv_formato";
        //$result = parent::GetResult($query);
        //$oFormato->formatoID = parent::fetchScalar($result)+1;
        //$oFormato->varName    = $oFormato->formatoID;
        //Insert data to table
    $query = " 	INSERT INTO gnv_formato(formatoID, userID, userAdmID, fechaCreacion, estado)

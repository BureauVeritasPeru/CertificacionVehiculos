...
class GnvCalcomania extends Database
{
	...
	public static function  getList_Paging(){
		$query = "	
                    ...
                    FROM gnv_calcomania f INNER JOIN crm_user a
    ...
    public static function  AddNew($oCalcomania){
        //Search the max Id
        //$query = " 	SELECT MAX(calcomaniaID) FROM gnv_calcomania";
        //$result = parent::GetResult($query);
        //$oCalcomania->calcomaniaID = parent::fetchScalar($result)+1;
        //$oCalcomania->varName    = $oCalcomania->calcomaniaID;
        //Insert data to table
        $query = " 	INSERT INTO gnv_calcomania(calcomaniaID, userID, userAdmID, fechaCreacion, estado)
    ...
    public static function  Update($oCalcomania){
        ...
        $query = " 	UPDATE gnv_calcomania SET 
    ...
    public static function  Delete($oCalcomania){
        $query = " 	DELETE FROM gnv_calcomania 
                	WHERE calcomaniaID ='$oCalcomania->calcomaniaID'
                    AND estado = 1";
        return parent::Execute($query);
    }
